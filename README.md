...
```                                                                                       
                     ...
                     88                                                                 
                     88                                                                 
,adPPYYba,   ,adPPYb,88  8b       d8   ,adPPYb,d8  8b,dPPYba,   ,adPPYba,   ,adPPYb,d8  
""     `Y8  a8"    `Y88  `8b     d8'  a8"    `Y88  88P'   "Y8  a8P_____88  a8"    `Y88  
,adPPPPP88  8b       88   `8b   d8'   8b       88  88          8PP"""""""  8b       88  
...
Part Three
    ...
    ◉ Write a C program to input marks of five subjects Physics, Chemistry, Biology, Mathematics and Computer. Calculate percentage and grade according to following: Percentage >= 90% : Grade A Percentage >= 80% : Grade B Percentage >= 70% : Grade C Percentage >= 60% : Grade D Percentage >= 40% : Grade E Percentage < 40% : Grade F 22.
